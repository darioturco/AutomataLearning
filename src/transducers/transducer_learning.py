...
class Learner:
  def __init__(self, max_states, alphabet_in, alphabet_out, entropy_weight=0, lazy_bias=1.0, train_step_n=1000, epsilon_error= 0.000001, learning_rate=0.25, b1=0.5, b2=0.5, verbose=0):
