...
from src.utils import sample_dataset, get_separate_char, save_pickle, load_pickle
...
def get_algorithms():
    return {'ktails': lambda alp, xs, ys, max_states: AutomataLearner(alp).learn_from_k_tail(filter_positives(xs, ys), k=None),
